...
public class PoseDetectorProcessor
  ...
  public PoseDetectorProcessor(Context context, PoseDetectorOptionsBase options, boolean showInFrameLikelihood, boolean visualizeZ, boolean rescaleZForVisualization, boolean runClassification, boolean isStreamMode) {
    super(context);
  ...
  protected Task<PoseWithClassification> detectInImage(InputImage image) {
    return detector
            .process(image)
            .<PoseWithClassification>continueWith(
                    classificationExecutor,
                    new Continuation<Pose, PoseWithClassification>() {
                      @Override
